...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 380px;"> - HARRY POTTER  -</h6>
      <p style="margin-left: 380px;margin-top: -20px;">-by every children's memory</p>
      <img  src="../images/demo/backgrounds/46.jpg" style="margin-left: 340px;">
      <p>Very informative and over flowing with literature!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_t_1.php" method="post">
