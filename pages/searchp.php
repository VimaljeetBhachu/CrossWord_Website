        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Operations</a>
            <ul>
              ...
              <li><a href="#">Search</a><ul><li class="active"><a href="searchp.php">Search User</a></li><li><a href="b_search.php">Search Book</a></li></ul></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
     <h1 style="margin-left: 430px; font-family: monospace; font-weight: bold; text-decoration: underline; color: #368BC1;">Search User Info</h1>
      <div class="scrollable">
        <div id="comments">
        <div  style="padding-left: 438px;">
        <form action="search1.php" method="post">
          <div class="one_third first">
            <label for="name">Search id<span>*</span></label>
          ...
          <div style="padding-top: 100px; padding-left: 8px;">
            <input style="background-color: #3B9C9C; color: white;" type="submit" name="Search" value="Search">
          </div>
        </form>
      </div>
      </div>
