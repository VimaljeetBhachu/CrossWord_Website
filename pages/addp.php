        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Operations</a>
            <ul>
              ...
              <li><a href="#">Add</a><ul><li class="active"><a href="addp.php">Add User</a></li><li><a href="b_add.php">Add Book</a></li></ul></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h1 style="margin-left: 430px; font-family: monospace; font-weight: bold; text-decoration: underline; color: #368BC1;">Add User Info</h1>
      <div class="scrollable">
        ...
        <form action="add.php" method="post">
          ...
          <div style="padding-top: 180px; padding-left: 160px;">
            <input style="background-color: #3B9C9C; color: white;" type="submit" name="Add" value="Add">
          </div>
        </form>
      </div>
      </div>
