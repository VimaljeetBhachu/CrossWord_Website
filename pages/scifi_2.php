...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
     <h6 style="margin-left: 395px;"> - THE TIME MACHINE - </h6>
      <p style="margin-left: 430px;margin-top: -20px;">H.G WELLS</p>
      <img  src="../images/demo/backgrounds/72.jpg" style="margin-left: 350px;" >
      <p>It's Very Scarry Dont read thiss!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_s_2.php" method="post">
