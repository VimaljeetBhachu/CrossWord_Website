...
<html>
<head>
<title>Admin Books Ordered View</title>
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Operations</a>
            <ul>
              <li><a href="#">View</a><ul><li><a href="admin.php">View Users</a></li><li><a href="bview.php">View Books</a></li><li class="active"><a href="bview.php">View Orders</a></li></ul></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h1 style="margin-left: 380px; font-family: monospace; font-weight: bold; text-decoration: underline; color: #368BC1;">List of Books Ordered</h1>
        ...
        <table>
          <tbody>
            <?php
              ...
              {
                 $result = mysqli_query($con,"SELECT * FROM bookone");
                $cnt=0;
                while($row = mysqli_fetch_array($result))
                 ...
                 if($cnt == "null")
                 {
                   ...
                   <body>
                   <div style="padding-left: 440px; font-family: monospace; font-weight: bold; font-size: 20px;">No Books Ordered</div>
                   </body>
                   </html>
                   <?php
                 }
                 ...
                 {   
                    $result = mysqli_query($con,"SELECT * FROM copy_confirm");
