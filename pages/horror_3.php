        ...
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="#">Zoners</a>
            <ul>
              ...
              <li><a href="scifi.php><a href="horror.php">Horror</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 410px;"> - Spencer Seidel - </h6>
      <p style="margin-left: 445px;margin-top: -20px;">A Horror Novel</p>
      <img  src="../images/demo/backgrounds/11.jpg" style="margin-left: 350px;" >
