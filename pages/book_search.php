...
<html>
<head>
<title>Admin Users Search Result</title>
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/2.jpg');">
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Operations</a>
            <ul>
              <li><a href="#">View</a><ul><li class="active"><a href="admin.php">View Users</a></li><li><a href="bview.php">View Books</a></li><li><a href="b_ordered_view.php">View Orders</a></li></ul></li>
  ...
  <div id="breadcrumb" class="hoc clear">
    <ul>
      <li><a href="home_admin.php">Home</a></li>
      <li><a href="#"> Admin Search View</a></li>
    </ul>
  </div>
</div>
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h1 style="margin-left: 380px; font-family: monospace; font-weight: bold; text-decoration: underline; color: #368BC1;">Searched Book Information</h1>
          ...
          <tbody>
            ...
            $Author =$_POST["Author"];
              ...
              else
              {
                if($operation=="Search")
                {
                  $result = mysqli_query($con,"select ID,Name,Author,Zoner,Price,Quantity from books_data where Author = '".$Author."' ");
