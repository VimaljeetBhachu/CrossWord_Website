...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 380px;"> - GAMES OF THRONES  -</h6>
      <p style="margin-left: 380px;margin-top: -20px;">-by R.R. Martin</p>
      <img  src="../images/demo/backgrounds/45.jpg" style="margin-left: 340px;">
      <p>Very informative and over flowing with literature!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_t_3.php" method="post">
