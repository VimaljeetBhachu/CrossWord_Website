...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content"> 
      <h6 style="margin-left: 410px;"> - JUNGLE BOOK - </h6>
      <p style="margin-left: 445px;margin-top: -20px;">Walt Disney's</p>
      <img  src="../images/demo/backgrounds/18.jpg" style="margin-left: 350px;" >
      <p>It's Very Scarry Dont read thiss!!</p>
      <div id="comments">
        <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_k_3.php" method="post">
