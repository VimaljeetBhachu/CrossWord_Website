      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li class="active"><a href="#"><span class="glyphicon glyphicon-shopping-cart"></span>  cart</a></li>
           <li><a href="confirmed.php">view booking</a></li>
        </ul>
    </header>
  </div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
      <h1 style="margin-left: 450px; font-family: monospace; font-weight: bold;"><span class="glyphicon glyphicon-shopping-cart"></span> Cart</h1>
      ...
      <div id="comments">
        ...
        <form action="cart_delete.php" method="post">
          <div class="one_third first">
            <label for="name">Delete by Order ID<span>*</span></label>
            <input style="border-color: #3B9C9C; box-shadow: 1px 1px 5px black;" type="text" name="Sno" id="Sno" value="" size="50" required>
          </div>
        ...
        <form action="confirm.php" method="post">
          <div style=" padding-left: 200px; margin-top: -55px;">
            <input style="background-color: #3B9C9C; color: white;" type="submit" name="cnfm" value="Confirm Booking">
          </div>
        </form>
      </div>
          </body>
