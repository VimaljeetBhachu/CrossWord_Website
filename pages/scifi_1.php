...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 380px;"> - THE INVISIBLE MAN  -</h6>
      <p style="margin-left: 380px;margin-top: -20px;">-by Ellen Daltov</p>
      <img  src="../images/demo/backgrounds/71.jpg" style="margin-left: 340px;">
      <p>Very informative and over flowing with literature!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_s_1.php" method="post">
