...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h1 style="margin-left: 380px; font-family: monospace; font-weight: bold; text-decoration: underline; color: #368BC1;">Searched User Information</h1>
          ...
          <tbody>
            ...
            $id =$_POST["id"];
              ...
              else
              {
                if($operation=="Search")
                {
                $result = mysqli_query($con,"select id,Username,Name,Mobile,Password from user where id = ".$id." ");
