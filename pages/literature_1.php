...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content"> 
      <h6 style="margin-left: 380px;"> - KITE RUNNER  -</h6>
      <p style="margin-left: 380px;margin-top: -20px;">-by Khaled Hossinni</p>
      <img  src="../images/demo/backgrounds/30.jpg" style="margin-left: 285px;">
      <p>Very informative and over flowing with literature!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_l_1.php" method="post">
