...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 360px;"> - MY ENGLISH - </h6>
      <p style="margin-left: 435px;margin-top: -20px;">e-Book</p>
      <img  src="../images/demo/backgrounds/19.jpg" style="margin-left: 335px;">
      <p style="margin-left: 385px;" >For small children below 6years!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_k_4.php" method="post">
