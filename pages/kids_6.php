  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      <div id="logo" class="fl_left">
        <h1><a href="../index.html">CROSSWORD</a></h1>
        <p>----Online Book Shop----</p>
      </div>
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          <li><a href="../edited.html">Home</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content"> 
      <h6 style="margin-left: 360px;"> - THE INCREDIBLE HULK - </h6>
      <p style="margin-left: 435px;margin-top: -20px;"> - by MARVEL</p>
      <img  src="../images/demo/backgrounds/21.gif" style="margin-left: 335px;">
      <p style="margin-left: 385px;" >For small children below 6years!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_k_6.php" method="post">
