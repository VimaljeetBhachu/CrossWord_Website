...
<html>
<head>
<title>Admin Books Delete</title>
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/2.jpg');"> 
        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Operations</a>
            <ul>
              ...
              <li><a href="#">Delete</a><ul><li><a href="deletep.php">Delete User</a></li><li class="active"><a href="b_delete.php">Delete Book</a></li></ul></li>
            </ul>
          </li>
        </ul>
    </header>
  ...
  <div id="breadcrumb" class="hoc clear">
    <ul>
      ...
      <li><a href="#"> Admin Books Delete</a></li>
    </ul>
  </div>
</div>
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h1 style="margin-left: 425px; font-family: monospace; font-weight: bold; text-decoration: underline; color: #368BC1;">Delete Books</h1>
    ...
    <form action="book_delete.php" method="post">
      <table style="width: 200px; margin-left: 400px;">
        <tbody>
          ...
          <tr>
            <td><input type="text" name="ID" id="ID" value="" placeholder="Delete by ID"></td>
          </tr>
        </tbody>
      </table>
