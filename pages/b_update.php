...
<html>
<head>
<title>Admin Books Update</title>
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/2.jpg');"> 
        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Operations</a>
            <ul>
              ...
              <li><a href="#">Update</a><ul><li><a href="updatep.php">Update User</a></li><li class="active"><a href="b_update.php">Update Book</a></li></ul></li>
  ...
  <div id="breadcrumb" class="hoc clear">
    <ul>
      ...
      <li><a href="#"> Admin Books Update</a></li>
    </ul>
  </div>
</div>
    ...
    <form action="book_update.php" method="post">
      <table>
        <tbody>
          ...
          <tr>
            <td><input type="text" name="ID" id="ID" value="" placeholder="Update by ID"></td>
            <td><input type="text" name="Name" id="Name" value="" placeholder="Enter New Name"></td>
            <td><input type="text" name="Author" id="Author" value="" placeholder="Enter New Author"></td>
            <td><input type="text" name="Zoner" id="Zoner" value="" placeholder="Enter New Zoner"></td>
            <td><input type="text" name="Price" id="Price" value="" placeholder="Enter New Prize"></td>
            <td><input type="text" name="Quantity" id="Quantity" value="" placeholder="Enter New Quantity"></td>
          </tr>
        </tbody>
      </table>
