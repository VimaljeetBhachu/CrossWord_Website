...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 360px;"> - A BRIEF HISTORY OF TIME - </h6>
      <p style="margin-left: 435px;margin-top: -20px;">Stephen Hawking</p>
      <img  src="../images/demo/backgrounds/74.jpg" style="margin-left: 335px;">
      <p style="margin-left: 385px;" >It's Very instresting.. read thiss!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_s_4.php" method="post">
