      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="#">Zoners</a>
            <ul>
              <li><a href="literature.phpdds">Literature</a></li>
              <li class="active"><a href="scifi.php">Sci-Fi</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
     <h6 style="margin-left: 410px;"> - THEORY OF EVERYTHING - </h6>
      <p style="margin-left: 445px;margin-top: -20px;">Stephen Hawking</p>
      <img  src="../images/demo/backgrounds/73.jpg" style="margin-left: 350px;" >
      <p>It's Very instresting... plzzz do read thiss!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_s_3.php" method="post">
