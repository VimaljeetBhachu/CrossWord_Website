      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Operations</a>
            <ul>
              <li><a href="#">View</a><ul><li><a href="admin.php">View Users</a></li><li><a href="bview.php">View Books</a></li><li><a href="bview.php">View Orders</a></li></ul></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
      <h1 style="margin-left: 430px; font-family: monospace; font-weight: bold; text-decoration: underline; color: #368BC1;">Welcome Admin</h1>
