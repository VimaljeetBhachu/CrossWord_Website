...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 380px;"> - PERCY JACKSON  -</h6>
      <p style="margin-left: 380px;margin-top: -20px;">-by Rick Rio</p>
      <img  src="../images/demo/backgrounds/48.jpg" style="margin-left: 340px;">
      <p>Very informative and over flowing with literature!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_t_4.php" method="post">
