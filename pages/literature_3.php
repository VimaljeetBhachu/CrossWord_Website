...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content">
      <h6 style="margin-left: 410px;"> - DAVID COPPERFIELD - </h6>
      <p style="margin-left: 445px;margin-top: -20px;">A Charles Dickens Book</p>
      <img  src="../images/demo/backgrounds/l_3.jpg" style="margin-left: 350px;" >
      <p>It's Very Scarry Dont read thiss!!</p>
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_l_3.php" method="post">
