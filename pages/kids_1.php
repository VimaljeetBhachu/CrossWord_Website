...
<title>Stories From Panchtantra</title>
<meta charset="utf-8">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <div class="content"> 
      <h6 style="margin-left: 380px;"> - Stories From Panchtantra  -</h6>
      <p style="margin-left: 380px;margin-top: -20px;">- Golden Set Books</p>
      <img  src="../images/demo/backgrounds/16.jpg" style="margin-left: 300px;">
      <p>Very informative and over flowing with literature!!</p>
      
      <div id="comments">
       <h2 style="margin-left: 380px;">Fill Details For Booking</h2>
        <form action="book_k_1.php" method="post">
