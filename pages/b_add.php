...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/2.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear">
    <ul>
      ...
      <li><a href="#"> Admin Books Add</a></li>
    </ul>
  </div>
</div>
      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td><input type="text" name="Author" id="Author" value="" placeholder="Enter Author"></td>
            <td><input type="text" name="Zoner" id="Zoner" value="" placeholder="Enter Zoner"></td>
            <td><input type="text" name="Price" id="Price" value="" placeholder="Enter Prize"></td>
            <td><input type="text" name="Quantity" id="Quantity" value="" placeholder="Enter Quantity"></td>
          </tr>
        </tbody>
      </table>
